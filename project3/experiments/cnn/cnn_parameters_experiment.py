...
time = end - start
print("total training time: {}".format(time))
plt.figure(1)
plt.plot(loss_arr, 'r', label='Loss with fewer parameters')
plt.plot(loss2_arr, 'g', label='Loss with more parameters')
plt.xlabel("Epochs")
plt.ylabel("Loss")
...
plt.figure(2)
plt.plot(train_acc_arr, 'r--', label='Train accuracy of CNN with fewer parameters')
plt.plot(train2_acc_arr, 'g--', label='Train accuracy of CNN with more parameters')
plt.plot(test_acc_arr, 'y', label='Test accuracy of CNN with fewer parameters')
plt.plot(test2_acc_arr, 'b', label='Test accuracy of CNN with more parameters')
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.title('# of Batches: 128')
plt.legend()
...
plt.figure(3)
plt.plot(test_acc_arr, 'r', label='Test accuracy of CNN with fewer parameters')
plt.plot(test2_acc_arr, 'g', label='Test accuracy of CNN with more parameters')
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.title('# of Batches: 128')
plt.legend()
